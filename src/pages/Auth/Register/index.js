...
function Register() {
  ...
  const onSubmit = (data) => {
    ...
    let years = moment().diff(data.birthday, 'years', false);
    if (years > 100 || years < 13) alert('Birthday is invalid!');
    else dispatch(registerAction(data));
  };
      ...
      <div className="row align-items-center g-lg-5">
        <div className="col-lg-7 text-start">
          <img
            className="w-75"
            alt="cgvcinemas-logo"
            src="https://firebasestorage.googleapis.com/v0/b/clone-music-web.appspot.com/o/Img-Spotify%2F3%20(1)%20(1).png?alt=media&token=602b699e-1f9f-4d13-a162-f453a470dece"></img>
          <p className="text-lg-start mt-3 fw-bold">
            Trải nghiệm điện ảnh chất lượng nhất tại cụm rạp BTL trên toàn quốc. <br></br>Trang
            thông tin tổng hợp lịch chiếu, trailers phim mới nhất tại BTL Cinemas Việt Nam.
          </p>
        </div>
